...
public class ZonaFitForma extends JFrame {
    ...
    private void createUIComponents() {
        ...
        // Restringmos la selección de la tabla a un solo registro
    ...
    private void eliminarCliente(){
        var renglonId = clientesTabla.getSelectedRow();
        if (renglonId != -1 ){
            var idEliminar = clientesTabla.getModel().getValueAt(renglonId,0).toString();
            this.idCliente =Integer.parseInt(idEliminar);
    ...
    private void cargarClienteSeleccionado(){
        ...
        if(renglon != -1) { //-1 significa que no se seleccionó ningun registro
    ...
    private void limpiarFormulario(){
        ...
        this.idCliente = null;
        // Deseleccionamps el resgistro seleccionado de la tabla
